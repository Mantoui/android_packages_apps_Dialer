...
import com.android.dialer.util.LocationUtil;
...
public class ChineseSmartDialMap implements SmartDialMap {
    ...
    public ChineseSmartDialMap(Context context) {
        mContext = context;
    }
    ...
    public char normalizeCharacter(char ch) {
        // Check if this char is Chinese word
        if (String.valueOf(ch).matches("[\u4E00-\u9FA5]"))
            return PinyinUtil.toPinyin(mContext, ch).charAt(0);
        else {
            switch (ch) {
                case 'À':
                    return 'a';
